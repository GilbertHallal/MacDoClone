...
import {collection, getFirestore, query, where, onSnapshot, addDoc} from 'firebase/firestore'
  ...
  function verify(){
    ...
    onSnapshot(q, (snapshot) => {
      ...
      if (email == "" || password == "" || confirm == "")
        ...
        setMessage("The password and the confirmation do not match")
      else 
      {
        addDoc(colref, {
          Email: email,
        ...
        <View style={styles.authBox}>
          ...
          <View style={styles.inputBox}>
            <TextInput
              ...
              outlineColor='#27251F'
              activeOutlineColor='#FFC72C'
              label={<Text style={styles.inputLabel}>Confirm password</Text>}
              style={styles.input}
              value={confirm}
